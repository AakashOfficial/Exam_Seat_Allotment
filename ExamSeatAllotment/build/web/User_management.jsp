...
function openWin1() {
     var mywindow2=
    window.open("modifyuser.jsp","_self");
...
function openWin2() {
     var mywindow3=
    window.open("deleteuser.jsp","_self");
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="#">USER NAME</a></li>
       ...
       <center>
           ...
           <input class="Button" type="button" value="ADD USER" class="submitButton" onclick="openWin()"/>    <input class="Button" type="button" value="REMOVE USER" class="submitButton"onclick="openWin2()"/>
           </br>
           </br>
           </br>
           </br>
           ...
           <center>
    <input class="Button" type="button" value="MODIFY USER" class="submitButton"onclick="openWin1()"/>   
           </center>
       </br>
